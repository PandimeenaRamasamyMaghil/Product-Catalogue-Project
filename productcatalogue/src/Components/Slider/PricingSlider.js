  ...
  return (
    <div className='PricingSlider-Container'>
     ...
     <div className='SectionB'>
      ...
      <input type='text' className={` ${!pen ? 'SectionB-InputDark' : 'SectionB-Input'}`}></input>
      <img src={Weigh} className='WeighImages'></img>
     </div>
     <h1 className='Ofprem-Heading'>Of-prem</h1>
     <div className='OfPickup'>
      <h1 className='OfPickup-Heading'>Pickup: </h1>
      <input type='text' className={` ${!pen ? 'OfPickup-InputDark' : 'OfPickup-Input'}`}></input>
     </div>
     <div className='OfDelivery'>
      <h1 className='OfDelivery-Heading'>Delivery: </h1>
      <input type='text' className={` ${!pen ? 'OfDelivery-InputDark' : 'OfDelivery-Input'}`}></input>
      
     </div>
     <div className='OfZomato'>
      <h1 className='OfZomato-Heading'>Zomato: </h1>
      <input type='text' className={` ${!pen ? 'OfZomato-InputDark' : 'OfZomato-Input'}`}></input>
      
     </div>
     <div className='OfSwiggy'>
      <h1 className='OfSwiggy-Heading'>Swiggy: </h1>
      <input type='text' className={` ${!pen ? 'OfSwiggy-InputDark' : 'OfSwiggy-Input'}`}></input>
      
     </div>
     <div className='OfUberEats'>
      <h1 className='OfUberEats-Heading'>UberEats: </h1>
      <input type='text' className={` ${!pen ? 'OfUberEats-InputDark' : 'OfUberEats-Input'}`}></input>
      
     </div>
     <div className='OfOther1'>
      <h1 className='OfOther1-Heading'>Other 1: </h1>
      <input type='text' className={` ${!pen ? 'OfOther1-InputDark' : 'OfOther1-Input'}`}></input>
      
     </div>
     <div className='OfOther2'>
      <h1 className='OfOther2-Heading'>Other 2: </h1>
      <input type='text' className={` ${!pen ? 'OfOther2-InputDark' : 'OfOther2-Input'}`}></input>
