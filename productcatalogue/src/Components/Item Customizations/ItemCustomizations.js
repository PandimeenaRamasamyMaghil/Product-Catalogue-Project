...
const ItemCustomizations = () => {
  ...
  const [options, setOptions] = useState(['Option3', 'Option 2', 'Option 3']);
  ...
  const addModifier = () => {
    setModifications([
      ...modifications,
      {
        modifierName: itemCustomizationData.modifierName|| "",
        options: [
          {
            item: "",
            price: "",
...
<div className="modifiersitem">
      ...
      {modifications.map((modifier, modIndex) =>(
        ...
        >
          {showModifiers && (
            <div className="AddModifiersMainInputSection">
              ...
              {modificationError.modifierName && (
                  <div className="error-message">{modificationError.modifierName}</div>
                )}
                  ...
                  modifier.options.map((option, optIndex) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        onBlur={handleBlur}
                      />
                      {modificationError.item && (
                  <div className="error-message1">{modificationError.item}</div>
                )}
                      ...
                      />
                         {modificationError.price && (
                  <div className="error-message2">{modificationError.price}</div>
                )}
              ...
              <div className="Spinner-input-ItemCustomizations">
                <div className="Spinner-inputlabel-ItemCustomizations">
                  ...
                  <input
                    ...
                    value={modifications[modIndex].minSelection}
                    name="minSelection"
                    onChange={(e) => handleModifierChange(modIndex, e)}
                  />
                ...
                <div className="Spinner-inputlabel-ItemCustomizations">
                  ...
                  <input
                    ...
                    value={modifications[modIndex].freeCustomization}
                    onChange={(e) => handleModifierChange(modIndex, e)}
                  />
                  <div className="polydiv-ItemCustomizations">
                    <img
                ...
                <Dropdown
                selectedValue={modifier.selectedValue}
